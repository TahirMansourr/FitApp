...
const UserProfile = (userId : string) => {
  ...
  return ( 
    <div className={isBlurred ?' backdrop-blur-2xl flex flex-col justify-center pt-20  bg-white dark:bg-black dark:text-white' : ' bg-white dark:bg-black dark:text-white flex flex-col justify-center z-50 pt-32 scale-110 '}>
